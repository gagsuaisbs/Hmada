...
CHANNELS_STR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = f"𓆩 **[ Multi HUNTER](t.me/isAndreew)** **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
...
async def count(event):
    ...
    result += f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 AndY ultra sourece **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
...
async def stats(event):
    ...
    response = f"𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 AndY ultra sourece **- 🝢 - معلومات {full_name}** 𓆪\n"
